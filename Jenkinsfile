pipeline {
    ...
    environment {
        ...
        ALLURE_REPORT_DIR = 'allure-report'        // Directory to store the generated Allure report
    }
        ...
        stage('Run Playwright Tests') {
            steps {
                script {
                    ...
                    bat "docker exec ${CONTAINER_NAME} allure generate ${ALLURE_RESULTS_DIR} --clean -o ${ALLURE_REPORT_DIR}"
                }
            }
        }
