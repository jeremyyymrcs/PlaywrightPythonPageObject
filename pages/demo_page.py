...
class DemoPage(ActionHandler):
    ...
    def demo_site_practice(self):
        ...
        try:
            ...
            self.type("id", DemoPageLocators.TEXT_INPUT_FIELD, "This is Automated")
            self.type("css", DemoPageLocators.TEXT_AREA, "Testing Time!\n")
            self.type("css", DemoPageLocators.PRE_FILLED_TEXT_FIELD, "Typing Text!")
            self.type("placeholder", DemoPageLocators.PLACE_HOLDER_TEXT_FIELD, "This is Automated")
